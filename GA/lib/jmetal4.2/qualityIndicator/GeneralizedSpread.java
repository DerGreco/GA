 ...
 * $ java qualityIndicator.GeneralizedSpread <solutionFrontFile> <trueFrontFile> <numberOfObjectives>
...
public class GeneralizedSpread {
  ...
  public static qualityIndicator.util.MetricsUtil utils_;  // MetricsUtil provides some 
  ...
  public GeneralizedSpread() {
    utils_ = new qualityIndicator.util.MetricsUtil();
  } // GeneralizedSpread
  ...
  public double generalizedSpread(double [][] paretoFront,
    ...
    for (int i = 0; i < numberOfObjectives; i++) {
      Arrays.sort(normalizedParetoFront,new qualityIndicator.util.ValueComparator(i));
    ...
    Arrays.sort(normalizedFront,new qualityIndicator.util.LexicoGraphicalComparator());
