 ...
 * "java qualityIndicator.InvertedGenerationalDistance <solutionFrontFile> <trueFrontFile> 
 * <numberOfObjectives>"
...
public class InvertedGenerationalDistance {
  public qualityIndicator.util.MetricsUtil utils_;  //utils_ is used to access to the
