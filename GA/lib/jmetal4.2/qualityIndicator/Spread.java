 ...
 *  "java qualityIndicator.Spread <solutionFrontFile> <trueFrontFile>". 
...
public class Spread {
  ...
  public static qualityIndicator.util.MetricsUtil utils_;//utils_ is used to access to 
  ...
  public double spread(double [][] front, 
    ...
    Arrays.sort(normalizedFront,
    		    new qualityIndicator.util.LexicoGraphicalComparator());
