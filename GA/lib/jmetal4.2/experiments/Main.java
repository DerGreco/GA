...
public class Main {
   ...
   * Usage: three options
   *      - experiments.Main algorithmName
   *      - experiments.Main algorithmName problemName
   *      - experiments.Main algorithmName problemName paretoFrontFile
  ...
  public static void main(String [] args) throws
    ...
    if (args.length == 0) { //
      ...
      System.err.println("a) experiments.Main algorithmName ") ;
      System.err.println("b) experiments.Main algorithmName problemName") ;
      System.err.println("c) experiments.Main algorithmName problemName paretoFrontFile") ;
      System.exit(-1) ;
    } // if
