...
public class XInt {
	...
	public int getValue(int index) throws JMException {
		if (type_.getClass() == IntSolutionType.class){
			...
			Configuration.logger_.severe("util.wrapper.XInt.getValue, solution type " +
					type_ + "+ invalid") ;		
		}
		return 0;
	} // Get value
	...
	public void setValue(int index, int value) throws JMException {
		if (type_.getClass() == IntSolutionType.class)
			...
			Configuration.logger_.severe("util.wrapper.XInt.setValue, solution type " +
					type_ + "+ invalid") ;		
	} // setValue	
	...
	public int getLowerBound(int index) throws JMException {
		if (type_.getClass() == IntSolutionType.class)
			...
			Configuration.logger_.severe("util.wrapper.XInt.getLowerBound, solution type " +
					type_ + "+ invalid") ;		
		}
		return 0 ;
	} // getLowerBound
	...
	public int getUpperBound(int index) throws JMException {
		if (type_.getClass() == IntSolutionType.class)		
			...
			Configuration.logger_.severe("util.wrapper.XInt.getUpperBound, solution type " +
					type_ + "+ invalid") ;		
	...
	public int getNumberOfDecisionVariables() {
		if (type_.getClass() == IntSolutionType.class)		
			...
			Configuration.logger_.severe("util.wrapper.XInt.size, solution type " +
					type_ + "+ invalid") ;		
		return 0 ;
	} // size
} // XInt