...
package metaheuristics.singleObjective.particleSwarmOptimization;
...
public class PSO_main {
   ...
   * Usage: three options
   *      - metaheuristics.mocell.MOCell_main
   *      - metaheuristics.mocell.MOCell_main problemName
   *      - metaheuristics.mocell.MOCell_main problemName ParetoFrontFile
   */
