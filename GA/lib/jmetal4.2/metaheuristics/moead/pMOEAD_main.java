...
public class pMOEAD_main {
   ...
   * Usage: three options
   *      - metaheuristics.moead.MOEAD_main
   *      - metaheuristics.moead.MOEAD_main problemName
   *      - metaheuristics.moead.MOEAD_main problemName ParetoFrontFile
