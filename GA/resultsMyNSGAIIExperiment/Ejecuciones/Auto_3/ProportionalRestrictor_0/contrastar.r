...
fuentesdatos<-list.files(pattern="SPREAD.res")
...
write.table(resultados, file = "Contrastes", append = FALSE, sep = "\t")
#unlink("Resultados")

write.table(estadisticos, file = "Estadisticos", append = FALSE, sep = "\t")
#unlink("Estadisticos")
