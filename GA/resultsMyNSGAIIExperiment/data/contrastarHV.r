...
fuentesdatos<-list.files(pattern="HV.res")
...
write.table(resultados, file = "Contrastes.HV", append = FALSE, sep = "\t")
#unlink("Resultados")

write.table(estadisticos, file = "Estadisticos.HV", append = FALSE, sep = "\t")
#unlink("Estadisticos")
