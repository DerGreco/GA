...
fuentesdatos<-list.files(pattern="IGD.res")
...
write.table(resultados, file = "Contrastes.IGD", append = FALSE, sep = "\t")
#unlink("Resultados")

write.table(estadisticos, file = "Estadisticos.IGD", append = FALSE, sep = "\t")
#unlink("Estadisticos")
